...
async function main() {
  ...
  //so everyone is just deploying new contract each time instead of reusing
  //it worth looking into reusing long term but for learning just redeploy
  ...
  if(remainingBalance < BALANCE_AMOUNT_DAI){
...
main()
//npx hardhat run --network hardhat scripts/FlashLoanExampleScript.js